...
struct ContentView: View {
    ...
    @State var latitudeData: [[Double]]?
    @State var longitudeData: [[Double]]?
    @State var slopeData: [[Double]]?
...
//            DoubleFile.fromCSV(fileName: "slope") { result in
//                self.slopeData = result
//            }
//            DoubleFile.fromCSV(fileName: "longitude") { result in
//                self.longitudeData = result
//            }
//            DoubleFile.fromCSV(fileName: "latitude") { result in
//                self.latitudeData = result
//            }
        })
    }
